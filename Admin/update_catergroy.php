...
if (isset($_POST['btnsub'])) {
    ...
    $qry = mysqli_query($con, "update catrgory_master set cname='$name',photo='$photo',cdate=now() where cid='$cid'");
                        ...
                        <div class="modal-body">
                            <form method="post" autocomplete="off" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" name="pic" accept=".jpg,.png,.webp,.jpeg" id="image" class="form-control" value="<?php echo $row['photo'] ?>" >
                                </div>
