...
$qry1 = mysqli_query($con, "select * from gallery where gid=$gid");
...
if (isset($_POST['btnsub'])) {
    ...
    $qry = mysqli_query($con, "update gallery set title='$title',image='$photo' where gid='$gid'");
    ...
    <div class="page-header">
        ...
        <div class="d-flex">
            <div class="justify-content-center">
                <input type="button" class="btn ripple btn-main-primary" data-bs-target="#modaldemo1" data-bs-toggle="modal" id="btn" value="Edit Photos"></button>
            </div>
        </div>
    </div>
    <?php echo $alert; ?>
            ...
            <div class="modal-dialog wd-xl-400" role="document">
                <div class="modal-content">
                    <div class="modal-body pd-20 pd-sm-40">
                        <button aria-label="Close"  class="close pos-absolute t-15 r-20 tx-26" id="close" data-bs-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
                        <h5 class="modal-title mb-4 text-center">Edit Photo</h5>
                        ...
                        <img src="../Photographer/Images/<?php echo $row1['image']; ?>" style="height: 100px;"><br><br>
