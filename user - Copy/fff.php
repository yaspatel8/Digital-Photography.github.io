						...
						<div class="row">
							<div class="col-md-3">
								...
								<div id="footer-logo">
									...
									?>
									<a href="index.html" class="logo-dark"><img src="<?php echo "../Images/$row[image]"; ?>" alt="logo"></a>
									<a href="index.html" class="logo-light"><img src="<?php echo "../Images/$row[image]"; ?>" alt="logo"></a>
									

									<!-- for small screens -->
									<a href="index.html" class="logo-dark-m"><img src="<?php echo "../Images/$row[image]"; ?>" alt="logo"></a>
									<a href="index.html" class="logo-light-m"><img src="<?php echo "../Images/$row[image]"; ?>" alt="logo"></a>
									<br><br>
