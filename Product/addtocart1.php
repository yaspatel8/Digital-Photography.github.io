                                ...
                                ?>
                                    <tr>
                                        <td class="product-thumbnail">
                                            <a href="#"><img src="../product_image/<?php echo "$row1[photo]"; ?>" height=100 width=100></a>
                                        </td>
                                        <td class="product-name"><a href="#"><?php echo"$row1[pname]"; ?></a></td>
                                        <td class="product-price-cart"><span class="amount">&#8377;<?php echo"$row1[price]"; ?>/-</span></td>
                                        <td class="product-quantity">
                                            <div class="cart-plus-minus">
                                                <input class="cart-plus-minus-box" type="text" name="qtybutton" value="<?php echo"$row[cartqty]"; ?>" readonly>
                                            </div>
                                        </td>
