...
if (isset($_POST["btnsub"])) {
    ...
    $qry = mysqli_query($con, "update product_master set sid='$sid',pname='$name',description='$detail',price=$price,qty=$qty,photo='$photo',order_date=now() where pid='$pid'");
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            ...
                            <select name="sid" id="sid" class="form-select border mt-3 border-2 shadow bg-white text-dark " required>
                                ...
                                <?php
                                $qry2 = mysqli_query($con, "select * from sub_category");
                                if ($qry2) {
