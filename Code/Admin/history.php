                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        <td><?php echo $i++; ?></td>
                                            ...
                                            $status = $row['status'];
                                            if ($status == 1) {
                                                echo "<td>"; ?><span class='badge bg-success-light border-success' >Confirm</span></a>
                                                <?php "</td>";
                                                } else {
                                                echo "<td>"; ?><a href="order0.php?id=<?php echo $row['oid']; ?>"><span class='badge bg-danger-light border-danger fs-11' style="cursor: pointer;"> Not Confirm</span></a>
                                                <?php "</td>";
                                                }
                                            ?>
                                            <td><a href="delete_history.php?x=<?php echo $row['oid'];?>" class="btn btn-pill btn-danger" onclick="javascript: return confirm('Do Delete?')">Delete</a></td>
