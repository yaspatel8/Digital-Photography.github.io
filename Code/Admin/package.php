...
if (isset($_POST["btnsub"])) {
    ...
    $qry = mysqli_query($con, "insert into package_master values('','$sid','$name','$detail','$price','$qty','$photo',0,now())");
...
<body>
    <div class="card">
        <div class="card-header">
            <h4 class="page-title mb-1 text-primary">Add Package</h4>
        </div>
        <div>
        ...
        <div class="card-body">
            <form class="form-horizontal" method="post" enctype="multipart/form-data">
                <div class="form-group row">
                    ...
                    <div class="card-body">
                    <div class="form-group row">
                         <label for="inputName" class="col-md-3 form-label">Select Sub Category</label>
                        <div class="col-md-9">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="pname" class="form-control" id="pname" placeholder="Package Name" required>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="price" class="form-control" id="price" placeholder="Package Price" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputName" class="col-md-3 form-label">Quantity</label>
                        <div class="col-md-9">
                            <input type="text" name="qty" class="form-control" id="qty" placeholder="No. of packages you want to add " required>
                        </div>
                    </div>
                    <div class="form-group row">
