...
Your Photographer request has been Accepted For Alexander Photography.<br/>
Now You can Login to the website..<br/>
- Thank you.<br/><br/>
By Alexander Photography..!";
$qry = mysqli_query($con, "update photographer set status=1 where id=$id");
if ($qry) {
    echo smtp_mailer($email, "Photographer's Request has been Accepted", $message);
    echo "<script>window.location.assign('photoreq.php');</script>";
} else {
