...
if (isset($_POST['btnsub'])) {
    ...
    $qry = mysqli_query($con, "insert into product_image values('','$pid','$photo',now())");
        ...
        <div class="card-header">
            ...
            <div class="btn-list">
                <div class="card" id="modal">
                    <button class="btn btn-primary" style="margin-left: 100vh; margin-top:1vh;" data-bs-target="#modaldemo1" data-bs-toggle="modal">Add Product Image</button>
                </div>
            </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content modal-content-demo">
                        <div class="modal-header">
                            <h6 class="modal-title">Add Product image
                            ...
                            <tbody>
                                ...
                                ?>
                                    ...
                                    <tr class="text text-center">
                                        ...
                                        <td><?php echo "<image src='../product_image/$row[image]' height=50 width=50>" ?></td>
