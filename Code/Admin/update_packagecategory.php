...
$cid = $_GET['x'];
$qry = mysqli_query($con, "select * from packagecategory_master where cid=$cid");
...
if (isset($_POST['btnsub'])) {
    ...
    $qry = mysqli_query($con, "update packagecategory_master set cname='$name',photo='$photo',detail='$detail',cdate=now() where cid='$cid'");
        ...
        <div class="card-header">
            ...
            <div class="btn-list">
                <div class="card" id="modal">
                    <button class="btn btn-primary" style="margin-left: 100vh; margin-top:1vh;" data-bs-target="#modaldemo1" id="btn" data-bs-toggle="modal">Update New Category</button>
                </div>
            </div>
                    ...
                    <div class="modal-content modal-content-demo">
                        ...
                        <div class="modal-body">
                            <form method="post" autocomplete="off" enctype="multipart/form-data">
                                ...
                                <textarea id="content" name="content" class="form-control"  required><?php echo $row['detail']; ?></textarea>
                                
                                
                                <label>Old Image</label>
                                <img src="../package_image/<?php echo $row['photo']; ?>" style="height: 100px;"><br><br>
                                <input type="hidden" name="oldimage" value="<?php echo $row['photo']; ?>">
                                

                                <div class="form-group">
                                    <label class="image">Upload Image:</label>
                                    <input type="file" name="pic" id="image" accept=".jpg,.png,.webp,.jpeg" class="form-control" value="<?php echo $row['photo'] ?>" >
                                </div>
                            ...
                            <tbody>
                                ...
                                ?>
                                    ...
                                    <tr class="text text-center">
                                        ...
                                        <td><?php echo "<span class='avatar avatar-xl bradius' style='background-image: url(../package_image/$row[photo])'></span>" ?></td>
