...
if (isset($_POST['btnsub'])) {
    ...
    $qry1 = mysqli_query($con, "select * from catrgory_master where cname='$name'");
    ...
    {
        $qry = mysqli_query($con, "insert into catrgory_master values('','$name','$photo',0,now())");
        if ($qry) {
                            ...
                            <tbody>
                                ...
                                ?>
                                    ...
                                    <td><?php echo $i++; ?></td>
                                        ...
                                        <td class="fs-14"><img src="../product_image/<?php echo $row['photo']; ?>" style="height: 60px;"></td>
                                        <td class="fs-14"><?php echo $row['cname'] ?></td>
                                        <td class="fs-14"><?php echo $row['cdate'] ?></td>
                                        <?php
                                            $status = $row[3];
                                            if ($status == 0) {
                                                echo "<td>"; ?><a href="deactive_pro_c.php?cid=<?php echo $row['cid']; ?>"><span class='btn btn-pill btn-success' style="cursor: pointer;">Active</span></a>
                                                <?php "</td>";
                                                } else {
                                                echo "<td>"; ?><a href="active_pro_c.php?id=<?php echo $row['cid']; ?>"><span class='btn btn-pill btn-danger' style="cursor: pointer;"> Deactive</span></a>
                                                <?php "</td>";
                                                }
                                            ?>
