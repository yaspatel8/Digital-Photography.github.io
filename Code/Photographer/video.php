...
if (isset($_POST['btnsub'])) {
    ...
    $qry = mysqli_query($con, "insert into video values('',$id,'$title','$photo',0)");
    ...
    <div class="page-header">
        ...
        <div class="d-flex">
            <div class="justify-content-center">
                <input type="button" class="btn ripple btn-main-primary" data-bs-target="#modaldemo1" data-bs-toggle="modal" value="Add Videos"></button>
            </div>
        </div>
    </div>
    <?php echo $alert; ?>
            ...
            <div class="modal-dialog wd-xl-400" role="document">
                <div class="modal-content">
                    <div class="modal-body pd-20 pd-sm-40">
                        ...
                        <div class="form-group">
                            <input type="file" accept=".mp4" class="dropify" name="pic" id="pic" data-default-file="" data-height="110" required>
                        </div>
                            ...
                            <tbody>
                                ...
                                <td><?php echo $i++; ?></td>
                                    ...
                                    <td><?php 
                                            ...
                                            if($status==0)
                                            {
                                               ?> <a href="video_active.php?x=<?php echo $row['vid'];?>" class="btn ripple btn-danger btn-rounded"><i class="fe fe-right"></i> Dective</a>
                                            <?php } else { ?><a href="video_deactive.php?x=<?php echo $row['vid'];?>" class="btn ripple btn-success btn-rounded"><i class="fe fe-right"></i> Active</a>
                                                <?php } ?>
                                    </td>                                                                                                    
