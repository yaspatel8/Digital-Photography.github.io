	...
	<section id="prices-section">
		...
		<div class="prices-section-inner tt-wrap"> <!-- add/remove class "tt-wrap" to enable/disable element boxed layout (class "tt-boxed" is required in <body> tag! ) -->
			...
			<div class="price-boxes-container margin-bottom-80">
				<div class="row">
				<?php
				$categories = mysqli_query($con, "select * from packagecategory_master");
                     ...
                     ?>
							<div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
								...
								<!-- Begin price box -->
								<div class="price-box">
									<div class="pr-box price-heading bg-image"  style="background-image: url(assets/img/misc/<?php echo $row['photo'] ?>);">
									...
									<div class="pr-box price-features">
									  <?php $details = explode('<br />', $row['detail']); 
									...
									<div class="pr-box">
										<a href="weddingpack.php?cid=<?php echo $row['cid'] ?>" class="btn btn-price-box btn-dark btn-lg">Explore Now</a>
